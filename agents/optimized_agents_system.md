...
> 阅读本文时，请以“仅 SoT 联赛（五大联赛 + 世界杯）写回”为正式口径，并以 `collect-data -> predict-match -> save-result/auto-sync-results/sync-pending-results-review` 为正式流程基线。
...
- 足彩 14 场预测：`prediction_system.py predict-fourteen-issue --issue <期号> --json`
