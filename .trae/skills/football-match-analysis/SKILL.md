...
description: "足球比赛预测分析 skill，基于 collect-data / 实时快照 / app/cli.py -> DomainPredictor -> EnhancedPredictor / Harness 的正式链路，输出胜平负、比分、大小球、水位、风险与最终建议。Invoke when user needs match prediction, betting analysis, or match odds evaluation."
---
