...
description: "从澳客网(okooo.com)自动搜索获取足球比赛ID，支持英超、西甲等联赛。Invoke when user needs match\_id for specific football match or wants to get okooo match URLs."
----------------------------------------------------------------------------------------------------------------------------------------------------
...
| league\_hint | str | 否  | 联赛提示（如"英超"、"意甲"、"西甲"、"德甲"、"法甲"） |
...
项目已提供脚本 [okooo\_save\_snapshot.py](file:///Users/bytedance/trae_projects/europe_leagues/okooo_save_snapshot.py)，会按“热门赛事 → 联赛赛程 → MatchID → 欧赔/亚值/凯利”抓取并保存为 JSON。
...
### 3) 运行预测（写回 teams\_2025-26.md）

入口脚本：

- [optimized\_prediction\_workflow.py](file:///Users/bytedance/trae_projects/europe_leagues/optimized_prediction_workflow.py)
- [enhanced\_prediction\_workflow.py](file:///Users/bytedance/trae_projects/europe_leagues/enhanced_prediction_workflow.py)
...
- [okooo\_fetch\_daily\_schedule.py](file:///Users/bytedance/trae_projects/europe_leagues/okooo_fetch_daily_schedule.py)
...
现在各联赛的 [teams\_2025-26.md](file:///Users/bytedance/trae_projects/europe_leagues/la_liga/teams_2025-26.md) 不只是赛程文档，还承担两类数据职责：
...
- [result\_manager.py](file:///Users/bytedance/trae_projects/europe_leagues/result_manager.py)
  - `update_accuracy_stats()` 直接从 `teams_2025-26.md` 解析预测与赛果并统计准确率
- [import\_data.py](file:///Users/bytedance/trae_projects/europe_leagues/import_data.py)
