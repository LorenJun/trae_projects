...
description: "从澳客网移动端定位足球 MatchID，并衔接赛程抓取、实时快照、大小球补抓与下游 `app/cli.py -> DomainPredictor -> EnhancedPredictor` 预测入口。Invoke when user needs match_id, schedule lookup, or okooo realtime snapshot URLs."
---
